...
{
//var deleteAction = 'submitAction_win0(document.win0' + ',"' + name + '")';
var deleteAction = 'oParentWin.aAction_win0(oParentWin.document.win0' + ',"' + name + '")';
...
if (arguments.length == 0) // Non-AJAX mode, delete row parameter is not passed in so do a confirm
 ...
 {
 //var deleteAction = 'submitAction_win0(document.win0' + ',"' + arguments[0] + '")';

var deleteAction = 'oParentWin.aAction_win0(oParentWin.document.win0' + ',"' + arguments[0] + '")';
...
if (typeof popupObj_win0 != "undefined" && popupObj_win0 && popupObj_win0.isShown) 
    ptCommonObj2.tryFocus0(popupObj_win0.popupFocus);
...
{
  if(oChange_win0!=null && oChange_win0.form !=null && oChange_win0!=obj)
  {
...
if (typeof document.chgFldArr_win0 != "undefined" && document.chgFldArr_win0 != "undefined")
    {
    var bFound = false;
    for (var i = 0; i < document.chgFldArr_win0.length; i++) {
